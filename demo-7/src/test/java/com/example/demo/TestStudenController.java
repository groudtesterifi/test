...
public class TestStudenController {
	...
	public void testUpdateStudent() {
		...
		boolean updateStudent = testController.updateStudent(student);
		assertTrue(updateStudent);

		when(testController.findById(student.getId())).thenReturn(null);

		boolean updateStudent1 = testController.updateStudent(student);
		assertFalse(updateStudent1);
	...
	public void testDelete() {
		...
		boolean deleteStudent = testController.deleteStudent(student);
		assertTrue(deleteStudent);
		
		when(testController.findById(student.getId())).thenReturn(null);

		boolean deleteStudent1 = testController.deleteStudent(student);
		assertFalse(deleteStudent1);
	}
